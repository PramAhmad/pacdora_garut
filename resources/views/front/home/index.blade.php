...
<main>
          ...
          <div class="mb-8 flex flex-wrap items-center justify-between">
            ...
            <ul class="flex flex-wrap items-center">
              ...
              @foreach ($category as $c )
                <input type="hidden" name="mockupNameKey" value="{{$c->key}}">
              <li class="my-1 mr-2.5">
                <button
                  id="serach-category"
                  type="submit"
                ...
                >
                 <img src="{{$c['icon']}}" class="mr-1 h-4 w-4 fill-jacarta-700 transition-colors group-hover:fill-white dark:fill-jacarta-100" alt="">
                    <path fill="none" d="M0 0h24v24H0z" />
                    <path
    ...
    <script>
      $(document).ready(function () {
        ...
        $("#filtercategory").on("submit", function (e) {
          e.preventDefault();
          var form = $(this);
