          ...
          <form id="register-form" method="POST" action="{{ route('register.store') }}" enctype="multipart/form-data">
            ...
            <div class="flex space-x-7">
              ...
              <div class="mb-6 w-1/2">
                ...
                <input name="nohp" class="contact-form-input w-full rounded-lg border-jacarta-100 py-3 hover:ring-2 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white dark:placeholder:text-jacarta-300" id="nohp" type="number" required placeholder="Masukan 10-15 Digit Nomor HP" />
                @error('email')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
              </div>
            ...
            <div class="flex space-x-7">
              <div class="mb-6 w-1/2">
                ...
                <input name="nik" class="contact-form-input w-full rounded-lg border-jacarta-100 py-3 hover:ring-2 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white dark:placeholder:text-jacarta-300" id="no_ktp" type="number" required placeholder="Masukan Nomor KTP Sesuai KTP" />
                @error('no_ktp')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
              </div>
              ...
              <div class="mb-6">
                ...
                <div class="flex items-center space-x-4">
                  <div class="flex items-center space-x-2 ">
                    <input type="radio" id="is_garut_yes" name="is_garut" value="1" class="h-4 w-4 text-accent border-accent focus:ring-accent/20 dark:border-jacarta-600 dark:bg-jacarta-700" />
                    <label for="is_garut_yes" class="text-sm dark:text-jacarta-200">Ya</label>
                  </div>
                  <div class="flex items-center space-x-2 ">
                    <input type="radio" id="is_garut_no" name="is_garut" value="0" class="h-4 w-4 text-accent  border-accent focus:ring-accent/20 dark:border-jacarta-600 dark:bg-jacarta-700" />
                    ...
                    <div id="domisili_input" style="display: none;">
                      ...
                      <input type="text" id="domisili" name="domisili" placeholder="masukan domisili" class="contact-form-input w-full rounded-lg border-jacarta-100 py-3 hover:ring-2 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white dark:placeholder:text-jacarta-300" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="mb-6">
              ...
              <!-- textarea -->
              <textarea name="alamat_usaha" class="contact-form-input w-full rounded-lg border-jacarta-100 py-3 hover:ring-2 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white dark:placeholder:text-jacarta-300" id="alamat_usaha" required></textarea>
              @error('alamat_usaha')
              <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
              @enderror
            </div>
            ...
            <div class="flex space-x-7 mt-5">
              <div class="mb-6 w-1/2">
                ...
                <input name="email" class="contact-form-input w-full rounded-lg border-jacarta-100 py-3 hover:ring-2 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white dark:placeholder:text-jacarta-300" id="email" type="email" required />
                @error('email')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
              </div>
              ...
              <div class="mb-6 w-1/2">
                ...
                <input name="password" class="contact-form-input w-full rounded-lg border-jacarta-100 py-3 hover:ring-2 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white dark:placeholder:text-jacarta-300" id="password" type="password" required />
                @error('password')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
              </div>
          ...
          <div class="rounded-2.5xl border border-jacarta-100 bg-white p-10 dark:border-jacarta-600 dark:bg-jacarta-700">
            <div class="mb-6 flex items-center space-x-5">
              <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-jacarta-100 bg-light-base dark:border-jacarta-600 dark:bg-jacarta-700">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" class="fill-jacarta-400">
