      ...
      <section class="relative bg-light-base pb-12 pt-28 dark:bg-jacarta-800">
        ...
        <div class="absolute left-1/2 top-0 z-10 flex -translate-x-1/2 -translate-y-1/2 items-center justify-center">
          <figure class="relative">
            <img
              src="{{asset('template/dist/img/user/user_avatar.gif')}}"
        ...
        <div class="container">
          <div class="text-center">
            ...
            <div
              class="mb-8 inline-flex items-center justify-center rounded-full border border-accent bg-accent py-1.5 px-4 dark:border-accent dark:bg-accent"
            >
            
              <button
                class="js-copy-clipboard max-w-[10rem] select-none overflow-hidden text-ellipsis whitespace-nowrap text-white dark:text-jacarta-100"
            ...
            <div class="mb-12 md:w-1/2 md:pr-8">
              <div class="mb-6">
                <label for="profile-username" class="mb-1 block font-display text-sm text-jacarta-700 dark:text-white"
                  >Nama Usaha<span class="text-red">*</span></label
                >
                <input
                  type="text"
                  id="profile-username"
                ...
                <div class="mb-10 shrink-0 basis-8/12 space-y-5 lg:mb-0 lg:pr-10">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <span class="mb-3 block text-sm text-jacarta-500">listed by 051_Hart .08095 ETH</span>
