                ...
                <div class="col-span-12">
                  <div class="bg-white backdrop-blur-2xl rounded-2xl shadow-lg w-full relative p-4">
                    <div class="grid grid-cols-12 gap-4">
                      ...
                      <div class="col-span-10">
                        <div class="h-full flex flex-col p-3">
                          <a href="/subcategory/{{$sub->key}}" class="text-base font-semibold text-jacarta-600 dark:text-slate-200 block leading-5 truncate hover:underline hover:underline-offset-[4px] subcategory-link" data-key="{{ $sub->key }}">
                            {{ $sub->name }}
                          </a>
                        </div>
                      </div>
